...
const question1 = async () => {
  const answer = await inquirer.prompt({
    ...
    message: chalk.bold.hex(`#9E3C0E`)(
      "What is the TypeScript keyword used to declare a class property that should not be accessed from outside the class?\n"
    ),
...
const question2 = async () => {
  const answer = await inquirer.prompt({
    ...
    type: "list",
    message: chalk.bold.hex(`#9E3C0E`)(
      "In TypeScript, what is the purpose of the 'readonly' modifier for class properties?\n"
    ),
    choices: [
...
const question3 = async () => {
  const answer = await inquirer.prompt({
    ...
    type: "list",
    message: chalk.bold.hex(`#9E3C0E`)(
      "Which TypeScript feature allows you to define a type based on the shape of an existing object?\n"
    ),
    choices: [
      "Generics",
      "Interfaces",
...
const question4 = async () => {
  const answer = await inquirer.prompt({
    ...
    type: "list",
    message: chalk.bold.hex(`#9E3C0E`)(
      "In TypeScript, what is the purpose of the 'never' type?\n"
    ),
    choices: [
...
const question5 = async () => {
  const answer = await inquirer.prompt({
    ...
    type: "list",
    message: chalk.bold.hex(`#9E3C0E`)(
      "Which of the following TypeScript operators is used for combining two or more types into a single type?\n"
    ),
    choices: [
      "& (Intersection)",
      "| (Union)",
...
const question6 = async () => {
  const answer = await inquirer.prompt({
    ...
    type: "list",
    message: chalk.bold.hex(`#9E3C0E`)(
      "What does the 'keyof' operator return in TypeScript?\n"
    ),
    choices: [
...
const question7 = async () => {
  const answer = await inquirer.prompt({
    ...
    type: "list",
    message: chalk.bold.hex(`#9E3C0E`)(
      "In TypeScript, which of the following is a valid way to declare a function that accepts a callback function with two parameters of any type?\n"
    ),
    choices: [
...
const question8 = async () => {
  const answer = await inquirer.prompt({
    ...
    type: "list",
    message: chalk.bold.hex(`#9E3C0E`)(
      "What is a 'mapped type' in TypeScript used for?\n"
    ),
    choices: [
...
const question9 = async () => {
  const answer = await inquirer.prompt({
    ...
    type: "list",
    message: chalk.bold.hex(`#9E3C0E`)(
      "What is the purpose of the TypeScript 'as' keyword?\n"
    ),
    choices: [
...
const question10 = async () => {
  const answer = await inquirer.prompt({
    ...
    type: "list",
    message: chalk.bold.hex(`#9E3C0E`)(
      "What is the recommended way to enforce strict null checks in TypeScript?\n"
    ),
    choices: [
